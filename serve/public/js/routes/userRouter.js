...
rt.get('/getUserInfo', (req, res) => {
  ...
  User.findOne({mail}, (err, doc) => {
    let {name, mail, publicTop, authority, authDate, avatar, subPublicTop, publicData, role} = doc
    res.json({name, mail, publicTop, authority, authDate, avatar, subPublicTop, publicData, role})
  })
})
